...
namespace SmtpServer.Benchmarks
{
    ...
    {
        private static readonly IReadOnlyList<ArraySegment<byte>> Segments = Tokenize("The time has come for all good men\nto go to the aid of their country", "1 23 456 7890", "!@#$%^&*()");
        ...
        private static IReadOnlyList<ArraySegment<byte>> Tokenize(params string[] text)
        {
